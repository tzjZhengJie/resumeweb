...
<div class="overlay container-center mx-auto max-w-6xl text-white px-8 sm:px-0 mt-20 ">
	<div class="relative z-10 text-start" transition:fly={{ x: -50, duration: 500}}>
		...
		<div class="text-start"> 
				...
				<div class="flex justify-left items-center mt-8">
					<a class="anchor" href={`${assets}/Zheng Jie Resume.pdf`}>Download a copy of my CV</a>
				</div>
